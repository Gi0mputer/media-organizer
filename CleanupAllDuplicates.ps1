$folders = @(
    @{Path = "E:\2023"; Expected = "11.77 GB" },
    @{Path = "E:\2022"; Expected = "1.41 GB" },
    @{Path = "D:\2024"; Expected = "1.18 GB" },
    @{Path = "E:\2019"; Expected = "0.48 GB" },
    @{Path = "E:\2018 e pre"; Expected = "0.17 GB" },
    @{Path = "D:\2025"; Expected = "0.07 GB" },
    @{Path = "E:\2020"; Expected = "0.003 GB" }
)
...
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "WARNING: This will PERMANENTLY delete duplicate files!" -ForegroundColor Red
Write-Host "Total expected space recovery: ~15.5 GB" -ForegroundColor Yellow
Write-Host ""
...
foreach ($folder in $folders) {
    ...
    $output = & powershell -NoProfile -ExecutionPolicy Bypass -File $scriptPath -SourcePath $path -Delete 2>&1 | Out-String
